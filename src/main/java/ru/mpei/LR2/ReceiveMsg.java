	...
	public void action() {
		...
		if (receive != null) {
			...
			System.out.println(myAgent.getLocalName() +
					" agent gets data from informCount Agent to do count with next value:" +
					"  x = " + res[0] + ", delta = " + res[1]);
			...
			System.out.println(myAgent.getLocalName() + " agent make count: x - delta = " +
					result1 + ", x = " + result2+ ", x + delta = " + result3);
