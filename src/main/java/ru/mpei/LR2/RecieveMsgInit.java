	...
	public void action() {
		...
		if (receive != null) {
			...
			if (count == 3) {
				...
				System.out.println("Summa for: (x - delta) = " + sum1 + ", Summa for(x) = " + sum2
						+ ", Summa for(x+delta) = " + sum3 + " ,X = " + X1 + ", delta = " + Delta1);
				System.out.println("_________________________________________________________________________________________________________________________________");
				...
				if (Delta1 < 0.01) {
					...
					System.err.println("The MIN common summa is evaluated and equal = " + min + "  X = " +
							X1 + ",  delta = " + Delta1);
